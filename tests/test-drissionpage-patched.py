...
co.set_user_agent(f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36")

browser = Chromium(co)
page = browser.get_tabs()[-1]
page.get("https://hide.mn/en/proxy-list/?start=198")
